...
namespace Messages.Common
{
    ...
    public static class IMessageCode
    {
        public static MessageType MsgType(this IMessage iMsg)
        {
            return (MessageType)iMsg.MsgCode;
        }

        public static MessageType MsgType(this RawMessage rawMessage)
        {
            return (MessageType)rawMessage.MsgCode;
        }
    }
    ...
    public enum MessageType : ushort
    {
        ...
        // Procedural Server to DB Server messages
        PB_NFY_UPSERT_MAP,

...
onready var _select_target_gizmo_res := preload("res://systems/input/nodes/select_target.tscn")
onready var _select_path_gizmo_res := preload("res://systems/input/nodes/select_target_path.tscn")
